        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="rounded-xl overflow-hidden shadow-md h-[400px] bg-gray-200 flex items-center justify-center">
              {/* In a real implementation, this would be replaced with an actual Google Maps iframe */}
              <div className="text-center">
                <MapPin className="h-16 w-16 text-kimcom-600 mx-auto mb-4" />
                <p className="text-gray-700 text-lg">KimCom Tower, 456 Ngong Road, Nairobi</p>
                <p className="text-gray-500 mt-2">Google Maps integration would be here in production</p>
              </div>
            </div>
          </div>
        </section>
