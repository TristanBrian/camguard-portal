...
const About = () => {
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <img alt="KimCom Solutions Office" className="rounded-xl shadow-xl" src="/lovable-uploads/1852c9c3-af54-471d-91b1-ff1e106529de.jpg" />
              </div>
              <div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((value, index) => <div key={index} className="bg-white p-8 rounded-xl shadow-sm text-center">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="relative">
                ...
                <div className="space-y-12 relative">
                  {milestones.map((milestone, index) => <div key={index} className={`flex flex-col md:flex-row items-start ${index % 2 === 0 ? '' : 'md:flex-row-reverse'}`}>
        ...
        {/* CTA Section */}
        <CTASection title="Want to join our team?" description="We're always looking for talented individuals who share our passion for security and technology." primaryButtonText="View Careers" secondaryButtonText="Contact Us" bgColor="bg-kimcom-800" />
      </main>
